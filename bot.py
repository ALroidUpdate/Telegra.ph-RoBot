...
async def home(client, message):
  buttons = [[
    ...
    [
        InlineKeyboardButton('Our Channel🤝', url='http://telegram.me/AlroidDiscovery),
        InlineKeyboardButton('Source Code👨‍💻', url='https://github.com/ALroidUpdate/Telegra.ph-RoBot')
    ]]
...
Im a Telegra.ph Link Uploader That Can Upload Photo, Video And Gif
        
Simply send me photo, video or gif to upload to Telegra.ph and give you the link
        
Made With Love By @ALroidDiscovery</b>""",
